...
"${NACSOS_OPENALEX__SOLR_BIN}/solr" start -c --host "$NACSOS_OPENALEX__SOLR_HOST" --port "$NACSOS_OPENALEX__SOLR_PORT" --solr-home "$NACSOS_OPENALEX__SOLR_HOME" -Dconfigset.upload.enabled=false
