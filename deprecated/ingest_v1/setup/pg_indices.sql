...
CREATE INDEX IF NOT EXISTS topics_topic_id_idx ON openalex.topics USING hash(topic_id);
CREATE INDEX IF NOT EXISTS works_topics_work_id_idx ON openalex.works_topics USING hash(work_id);
CREATE INDEX IF NOT EXISTS works_topics_topic_id_idx ON openalex.works_topics USING hash(topic_id);
